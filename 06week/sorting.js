...
let arrNums = stringsToNumbs(strNums)

const evenNums = arrNums.filter(elem => elem%2 === 0)

console.log(evenNums)


// 3. Find the index of the first value when added to it's index = 512 

const atxIdx = strNums[512]
console.log(`Index: ${atxIdx}, Value: ${strNums[atxIdx]}`)
...
let weatherStates = [... new Set (weather
  .map(x => x.weather_state_name)
)]
...
const idealTempFilter = weather
  .filter(x => x.min_temp === 15.915)

console.log(idealTempFilter)